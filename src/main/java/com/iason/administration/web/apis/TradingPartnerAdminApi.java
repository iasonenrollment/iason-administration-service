package com.iason.administration.web.apis;
 ...
 * Class/Interface/Enum Name: TradingPartnerAdminApi
 * Inside the package - com.iason.administration.web.apis
 * Created Date: 5/22/2020
 * Created Time: 7:26 PM
 **/
@Tag(name = "Iason Adminstration Service", description = "APIs for Iason Admin Service")
public interface TradingPartnerAdminApi {
...
//            },
    ...
    String helloTradingPartnerService();
...
//            },
    ...
    @GetMapping(value="/trading-partners",
            produces = {"application/json"})
    ResponseEntity<TradingPartnerDto> getTradingPartners();
